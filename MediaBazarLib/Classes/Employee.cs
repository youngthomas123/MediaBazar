...
namespace S2GroupProject.Classes
{
	public class Employee
	{
		...
		public Employee( string firstName, string lastName, int bsn, int telNumber, string address, 
						...
						List<DayOfWeek> daysOff, int age,  bool? attendedShift, List<Shift> shiftsDates)
		{
		...
		public override string ToString()
		{
			...
			return $"{FirstName.Substring(0, 1)}. {LastName.Substring(0, 1)}. BSN: {BSN} Num: {TelNumber} Working as: {Jobposition} {AttendedShift}, {daysOff}, {shiftDatesString}";
		}
	}
}
